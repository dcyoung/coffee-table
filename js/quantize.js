...
var quantize = function (img, colors) {
    ...
    var source_canvas = new Canvas(width, height);
    ...
    var quantized_canvas = new Canvas(width, height);
...
loadImage("./resources/depth_map_raw.png").then(img => {
    ...
    var canvas = quantize(img, centroids);
    fs.writeFileSync("./output/quantized.png", canvas.toBuffer("image/png"));
})